...
export const enrichmentAttempts: EnrichmentAttempt[] = [
  ...
  { id: "ea-015", leadId: "lead-015", provider: "Hunter.io", status: "success", confidence: 0.92, fieldsFound: ["email", "title", "company"], timestamp: "2026-02-11T10:00:00Z", payload: { source: "hunter", matchType: "email_pattern" } },
];
...
export const eventLogs: EventLog[] = [
  ...
  { id: "ev-031", leadId: "lead-003", type: "discovered", description: "Lead descubierto vía Google Search", metadata: { searchJobId: "sj-001" }, timestamp: "2026-01-15T09:00:00Z" },
  { id: "ev-032", leadId: "lead-003", type: "enriched", description: "Enriquecido vía Clearbit", metadata: { confidence: "0.98" }, timestamp: "2026-02-03T10:00:00Z" },
  { id: "ev-033", leadId: "lead-003", type: "enrolled", description: "Inscrito en secuencia 'Outreach Hoteles España'", metadata: { sequenceId: "seq-001" }, timestamp: "2026-02-05T09:00:00Z" },
  { id: "ev-034", leadId: "lead-009", type: "discovered", description: "Lead descubierto vía Directorios sectoriales", metadata: { searchJobId: "sj-002" }, timestamp: "2026-02-22T14:00:00Z" },
  { id: "ev-035", leadId: "lead-015", type: "discovered", description: "Lead descubierto vía Turismo de Portugal", metadata: { searchJobId: "sj-003" }, timestamp: "2026-02-21T08:00:00Z" },
  { id: "ev-036", leadId: "lead-013", type: "discovered", description: "Lead descubierto vía Turismo de Portugal", metadata: { searchJobId: "sj-003" }, timestamp: "2026-02-22T11:00:00Z" },
];
...
export const companies: Company[] = [
  ...
  { id: "comp-010", name: "Urban Hotel Collection", domain: "urbanhotel.es", website: "https://urbanhotel.es", industry: "Hospitality", country: "España", city: "Madrid", employees: 320, source: "Google Search", enrichmentStatus: "enriched", contactIds: ["lead-003"], discoveredAt: "2026-01-15T09:00:00Z" },
...
export const prospectLists: ProspectList[] = [
  { id: "list-001", name: "Hoteles Boutique España", contactCount: 8, source: "search", contactIds: ["lead-001", "lead-002", "lead-003", "lead-008", "lead-012", "lead-014"], createdAt: "2026-01-15T10:00:00Z" },
  { id: "list-002", name: "Resorts LATAM", contactCount: 6, source: "search", contactIds: ["lead-004", "lead-005", "lead-007", "lead-009", "lead-011"], createdAt: "2026-01-20T10:00:00Z" },
  { id: "list-003", name: "Hoteles Portugal", contactCount: 4, source: "search", contactIds: ["lead-006", "lead-010", "lead-015", "lead-013"], createdAt: "2026-02-01T10:00:00Z" },
  { id: "list-004", name: "Directores Generales España", contactCount: 3, source: "ai", contactIds: ["lead-001", "lead-014", "lead-003"], createdAt: "2026-02-10T10:00:00Z" },
];
...
export const inboxThreads: InboxThread[] = [
  ...
  {
    id: "thread-005", leadId: "lead-008", leadName: "Pedro Navarro", leadCompany: "Palacio Hoteles", campaignId: "camp-001", aiTag: "question", unread: true, lastMessageAt: "2026-02-19T16:20:00Z",
    messages: [
      { id: "msg-005-1", direction: "outbound", subject: "Incrementa la fidelización de tus huéspedes con Palacio Hoteles", body: "Hola Pedro,\n\nSoy del equipo de Fideltour...", timestamp: "2026-02-17T09:30:00Z" },
      { id: "msg-005-2", direction: "inbound", subject: "Re: Fidelización Palacio Hoteles", body: "Buenas tardes,\n\n¿Qué integraciones tienen con los PMS? Nosotros usamos Opera Cloud.\n\nPedro Navarro\nDirector Comercial\nPalacio Hoteles", timestamp: "2026-02-19T16:20:00Z" },
    ],
  },
  {
...
export const enrichmentQueue: EnrichmentQueueItem[] = [
  ...
  { id: "eq-002", leadId: "lead-014", leadName: "Elena Torres", company: "Costa del Sol Resort", status: "processing", providers: ["Apollo.io"], fieldsRequested: ["email", "phone", "title", "linkedin", "company"], fieldsFound: ["email", "title"], confidence: 0.52, startedAt: "2026-02-24T08:28:00Z", completedAt: null, listName: "Hoteles Boutique España", error: null },
  ...
  { id: "eq-004", leadId: "lead-012", leadName: "Isabel Vega", company: "Hotel Monterrey Centro", status: "queued", providers: ["Hunter.io", "Snov.io"], fieldsRequested: ["email", "phone", "title", "linkedin"], fieldsFound: [], confidence: 0, startedAt: "2026-02-24T08:36:00Z", completedAt: null, listName: "Hoteles Boutique España", error: null },
  { id: "eq-005", leadId: "lead-001", leadName: "Carlos Martínez", company: "Gran Hotel Barcelona", status: "completed", providers: ["Clearbit", "Hunter.io"], fieldsRequested: ["email", "phone", "title", "linkedin", "company"], fieldsFound: ["email", "phone", "title", "linkedin", "company"], confidence: 0.95, startedAt: "2026-02-24T07:00:00Z", completedAt: "2026-02-24T07:02:00Z", listName: "Hoteles Boutique España", error: null },
  { id: "eq-006", leadId: "lead-002", leadName: "Ana López Ruiz", company: "Hotel Arte Madrid", status: "completed", providers: ["Clearbit"], fieldsRequested: ["email", "phone", "title", "linkedin"], fieldsFound: ["email", "phone", "title", "linkedin"], confidence: 0.86, startedAt: "2026-02-24T06:50:00Z", completedAt: "2026-02-24T06:52:00Z", listName: "Hoteles Boutique España", error: null },
  { id: "eq-007", leadId: "lead-013", leadName: "Andrés Ramírez", company: "Gran Colombia Hotel", status: "completed", providers: ["Hunter.io", "Snov.io"], fieldsRequested: ["email", "phone", "title"], fieldsFound: ["email", "title"], confidence: 0.80, startedAt: "2026-02-24T06:45:00Z", completedAt: "2026-02-24T06:48:00Z", listName: "Resorts LATAM", error: null },
  { id: "eq-008", leadId: "lead-006", leadName: "Pedro Fernandes", company: "Algarve Beach Resort", status: "failed", providers: ["Hunter.io"], fieldsRequested: ["email", "phone", "title"], fieldsFound: [], confidence: 0, startedAt: "2026-02-24T06:00:00Z", completedAt: "2026-02-24T06:01:00Z", listName: "Hoteles Portugal", error: "Dominio no encontrado en la base de datos" },
  { id: "eq-009", leadId: "lead-010", leadName: "Sofia Costa", company: "Lisboa Grand Hotel", status: "completed", providers: ["Hunter.io", "Clearbit"], fieldsRequested: ["email", "phone", "title", "linkedin"], fieldsFound: ["email", "phone", "title", "linkedin"], confidence: 0.90, startedAt: "2026-02-23T14:00:00Z", completedAt: "2026-02-23T14:03:00Z", listName: "Hoteles Portugal", error: null },
