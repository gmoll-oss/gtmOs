  ...
  if (!lead) {
    return (
      <div className="p-8 text-center" data-testid="text-contact-not-found">
        ...
        <Button variant="ghost" className="mt-4" onClick={() => navigate("/contacts")} data-testid="button-back-contacts">
  ...
  return (
    <div className="p-6 max-w-[1200px] mx-auto" data-testid="contact-detail-page">
      <div className="flex items-center gap-3 mb-6">
        <Button variant="ghost" size="sm" onClick={() => navigate("/contacts")} data-testid="button-back">
