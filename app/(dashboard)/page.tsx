    ...
    <div className="h-full overflow-y-auto">
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-5 gap-3" data-testid="kpi-cards">
          <Card className="cursor-pointer hover:border-primary/40 transition-colors" onClick={() => router.push("/contacts")} data-testid="kpi-contacts">
          ...
          <Card className="cursor-pointer hover:border-primary/40 transition-colors" onClick={() => router.push("/companies")} data-testid="kpi-companies">
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
          ...
          <Card className="cursor-pointer hover:border-primary/40 transition-colors" onClick={() => router.push("/campaigns")} data-testid="kpi-emails">
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
        ...
        <Card data-testid="pipeline-states">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" onClick={() => router.push("/contacts")} data-testid="button-view-all-contacts">
                Ver todos
        ...
        <div className="grid grid-cols-3 gap-4">
          <Card className="cursor-pointer hover:border-primary/40 transition-colors" onClick={() => router.push("/campaigns")} data-testid="card-campaigns-summary">
          ...
          <Card className="cursor-pointer hover:border-primary/40 transition-colors" onClick={() => router.push("/inbox")} data-testid="card-inbox-summary">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-semibold flex items-center gap-2">
